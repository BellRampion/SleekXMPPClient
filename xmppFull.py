...
class SendMsgBot(sleekxmpp.ClientXMPP):
    ...
    def send_message(self):
        ...
        while (send_new != '$'):
            ...
            send_new = input("Press Enter to send a message or '$' to cancel: ")
    ...
    def start(self, event):
        ...
        self.schedule(taskName, 30, send_message, args=None, kwargs=None, repeat=True)
